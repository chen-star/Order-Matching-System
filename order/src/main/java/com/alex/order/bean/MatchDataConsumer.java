...
import static com.alex.order.bean.MqttBusConsumer.INNER_MATCH_DATA_ADDR;
import static com.alex.order.config.WebSocketConfig.ORDER_NOTIFY_ADDR_PREFIX;
import static com.alex.order.config.WebSocketConfig.TRADE_NOTIFY_ADDR_PREFIX;
import static thirdparty.order.OrderDirection.BUY;
import static thirdparty.order.OrderDirection.SELL;
import static thirdparty.order.OrderStatus.*;
