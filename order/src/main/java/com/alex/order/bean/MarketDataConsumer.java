...
import static com.alex.order.bean.MqttBusConsumer.INNER_MARKET_DATA_CACHE_ADDR;
import static com.alex.order.config.WebSocketConfig.L1_MARKET_DATA_PREFIX;
...
public class MarketDataConsumer {
    ...
    //<code,最新的五档行情>
    private HashMap<String, L1MarketData> l1Cache = new HashMap<>();
